...
/**
 * Generated pattern matcher API of the hu.bme.mit.concerto.telecare.example.tdk.view.design.patterns.element_viewModel pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(IncQueryEngine)},
 * e.g. in conjunction with {@link IncQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link Element_viewModelMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * @see Element_viewModelQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class Element_viewModelMatcher extends BaseMatcher<Element_viewModelMatch> {
  /**
   ...
   * 
   */
  public static Element_viewModelMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    Element_viewModelMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new Element_viewModelMatcher(engine);
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(Element_viewModelMatcher.class);
   ...
   */
  @Deprecated
  public Element_viewModelMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public Element_viewModelMatcher(final IncQueryEngine engine) throws IncQueryException {
  ...
  @Override
  protected Element_viewModelMatch tupleToMatch(final Tuple t) {
    try {
    	return Element_viewModelMatch.newMatch((hu.bme.mit.inf.concerto.telecare.example.tdk.model.telecare.TelecareSystem) t.get(POSITION_TELECARESYSTEM));
  ...
  @Override
  protected Element_viewModelMatch arrayToMatch(final Object[] match) {
    try {
    	return Element_viewModelMatch.newMatch((hu.bme.mit.inf.concerto.telecare.example.tdk.model.telecare.TelecareSystem) match[POSITION_TELECARESYSTEM]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected Element_viewModelMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return Element_viewModelMatch.newMutableMatch((hu.bme.mit.inf.concerto.telecare.example.tdk.model.telecare.TelecareSystem) match[POSITION_TELECARESYSTEM]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<Element_viewModelMatcher> querySpecification() throws IncQueryException {
