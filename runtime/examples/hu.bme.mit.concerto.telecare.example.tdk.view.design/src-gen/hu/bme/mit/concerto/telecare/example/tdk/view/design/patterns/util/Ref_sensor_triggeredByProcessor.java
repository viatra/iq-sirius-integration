...
public abstract class Ref_sensor_triggeredByProcessor implements IMatchProcessor<Ref_sensor_triggeredByMatch> {
   ...
   * 
   */
  public abstract void process(final hu.bme.mit.inf.concerto.telecare.example.tdk.model.telecare.Sensor pSensor, final hu.bme.mit.inf.concerto.telecare.example.tdk.model.telecare.FixedIntervalTrigger pTrigger);
