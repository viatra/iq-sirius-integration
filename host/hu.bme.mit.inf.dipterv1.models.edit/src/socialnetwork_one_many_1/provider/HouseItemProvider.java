...
/**
 * This is the item provider adapter for a {@link socialnetwork_one_many_1.House} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HouseItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_House_address_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_House_address_feature", "_UI_House_type"),
				 Socialnetwork_one_many_1Package.Literals.HOUSE__ADDRESS,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((House)object).getAddress();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(House.class)) {
			case Socialnetwork_one_many_1Package.HOUSE__ADDRESS:
