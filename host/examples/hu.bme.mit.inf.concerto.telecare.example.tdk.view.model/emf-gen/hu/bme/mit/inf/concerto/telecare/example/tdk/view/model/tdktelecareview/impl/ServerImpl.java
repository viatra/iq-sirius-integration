 ...
 * <ul>
 *   <li>{@link hu.bme.mit.inf.concerto.telecare.example.tdk.view.model.tdktelecareview.impl.ServerImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ServerImpl extends MinimalEObjectImpl.Container implements Server {
	...
	protected EClass eStaticClass() {
		return TdktelecareviewPackage.Literals.SERVER;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TdktelecareviewPackage.SERVER__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TdktelecareviewPackage.SERVER__NAME:
				return getName();
		}
