 ...
 * @generated
 */
public class TdktelecareviewSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TdktelecareviewPackage.VIEW_MODEL: {
				ViewModel viewModel = (ViewModel)theEObject;
				T result = caseViewModel(viewModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TdktelecareviewPackage.TIGGER: {
				Tigger tigger = (Tigger)theEObject;
				T result = caseTigger(tigger);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TdktelecareviewPackage.SERVER: {
				Server server = (Server)theEObject;
				T result = caseServer(server);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TdktelecareviewPackage.SENSOR: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Tigger</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Tigger</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTigger(Tigger object) {
		return null;
	}
