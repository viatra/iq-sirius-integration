 ...
 * <ul>
 *   <li>{@link org.eclipse.incquery.viewmodel.traceability.impl.TraceabilityImpl#getTraces <em>Traces</em>}</li>
 *   <li>{@link org.eclipse.incquery.viewmodel.traceability.impl.TraceabilityImpl#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TraceabilityImpl extends MinimalEObjectImpl.Container implements Traceability {
	...
	protected EClass eStaticClass() {
		return TraceabilityPackage.Literals.TRACEABILITY;
	}
	...
	public EList<Trace> getTraces() {
		if (traces == null) {
			traces = new EObjectContainmentEList<Trace>(Trace.class, this, TraceabilityPackage.TRACEABILITY__TRACES);
		}
		return traces;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TraceabilityPackage.TRACEABILITY__ID, oldId, id));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TraceabilityPackage.TRACEABILITY__TRACES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TraceabilityPackage.TRACEABILITY__TRACES:
				return getTraces();
			case TraceabilityPackage.TRACEABILITY__ID:
				return getId();
		}
