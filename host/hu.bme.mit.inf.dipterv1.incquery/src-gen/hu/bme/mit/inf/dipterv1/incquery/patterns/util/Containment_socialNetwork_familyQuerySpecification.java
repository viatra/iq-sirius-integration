...
import hu.bme.mit.inf.dipterv1.incquery.patterns.Containment_socialNetwork_familyMatcher;
...
public final class Containment_socialNetwork_familyQuerySpecification extends BaseGeneratedEMFQuerySpecification<Containment_socialNetwork_familyMatcher> {
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public String getFullyQualifiedName() {
      return "hu.bme.mit.inf.dipterv1.incquery.patterns.containment_socialNetwork_family";
    }
    ...
    public Set<PBody> doGetContainedBodies() throws QueryInitializationException {
      ...
      try {
      {
      	...
      	new TypeConstraint(body, new FlatTuple(var_f), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://hu.bme.mit.inf.models/socialnetwork_base", "Man")));
      	new TypeConstraint(body, new FlatTuple(var_m), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://hu.bme.mit.inf.models/socialnetwork_base", "Woman")));
