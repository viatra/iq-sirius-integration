...
public class FamilyImpl extends MinimalEObjectImpl.Container implements Family {
	...
	protected EClass eStaticClass() {
		return Socialnetwork_many_one_2Package.Literals.FAMILY;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Socialnetwork_many_one_2Package.FAMILY__NAME, oldName, name));
	}
