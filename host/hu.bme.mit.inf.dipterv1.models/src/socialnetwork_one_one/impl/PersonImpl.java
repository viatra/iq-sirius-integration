...
public abstract class PersonImpl extends MinimalEObjectImpl.Container implements Person {
	...
	protected EClass eStaticClass() {
		return Socialnetwork_one_onePackage.Literals.PERSON;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Socialnetwork_one_onePackage.PERSON__NAME, oldName, name));
	}
