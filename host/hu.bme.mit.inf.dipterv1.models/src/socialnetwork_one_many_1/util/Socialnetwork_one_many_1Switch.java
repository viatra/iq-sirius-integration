 ...
 * @generated
 */
public class Socialnetwork_one_many_1Switch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public Socialnetwork_one_many_1Switch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Socialnetwork_one_many_1Package.SOCIAL_NETWORK: {
				SocialNetwork socialNetwork = (SocialNetwork)theEObject;
				T result = caseSocialNetwork(socialNetwork);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Socialnetwork_one_many_1Package.PERSON: {
				Person person = (Person)theEObject;
				T result = casePerson(person);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Socialnetwork_one_many_1Package.HOUSE: {
				House house = (House)theEObject;
				T result = caseHouse(house);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Socialnetwork_one_many_1Package.CAR: {
...
} //Socialnetwork_one_many_1Switch
