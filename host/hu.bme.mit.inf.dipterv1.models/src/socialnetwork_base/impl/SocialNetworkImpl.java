 ...
 * </p>
 * <ul>
 *   <li>{@link socialnetwork_base.impl.SocialNetworkImpl#getMembers <em>Members</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SocialNetworkImpl extends MinimalEObjectImpl.Container implements SocialNetwork {
	...
	protected EClass eStaticClass() {
		return Socialnetwork_basePackage.Literals.SOCIAL_NETWORK;
	}
	...
	public EList<Person> getMembers() {
		if (members == null) {
			members = new EObjectContainmentEList<Person>(Person.class, this, Socialnetwork_basePackage.SOCIAL_NETWORK__MEMBERS);
		}
		return members;
	}
