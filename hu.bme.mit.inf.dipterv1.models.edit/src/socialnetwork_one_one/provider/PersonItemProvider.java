...
/**
 * This is the item provider adapter for a {@link socialnetwork_one_one.Person} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PersonItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Socialnetwork_one_onePackage.Literals.PERSON__NAME,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Person.class)) {
			case Socialnetwork_one_onePackage.PERSON__NAME:
