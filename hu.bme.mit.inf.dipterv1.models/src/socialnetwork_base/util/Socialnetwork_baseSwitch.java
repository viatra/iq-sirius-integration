/**
 */
package socialnetwork_base.util;
 ...
 * @generated
 */
public class Socialnetwork_baseSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static Socialnetwork_basePackage modelPackage;
	 ...
	 * @generated
	 */
	public Socialnetwork_baseSwitch() {
		if (modelPackage == null) {
			modelPackage = Socialnetwork_basePackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Socialnetwork_basePackage.SOCIAL_NETWORK: {
				SocialNetwork socialNetwork = (SocialNetwork)theEObject;
				T result = caseSocialNetwork(socialNetwork);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Socialnetwork_basePackage.PERSON: {
				Person person = (Person)theEObject;
				T result = casePerson(person);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Socialnetwork_basePackage.MAN: {
			...
			case Socialnetwork_basePackage.WOMAN: {
