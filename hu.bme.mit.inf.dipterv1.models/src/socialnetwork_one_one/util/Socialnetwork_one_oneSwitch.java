 ...
 * @generated
 */
public class Socialnetwork_one_oneSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public Socialnetwork_one_oneSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Socialnetwork_one_onePackage.SOCIAL_NETWORK: {
				SocialNetwork socialNetwork = (SocialNetwork)theEObject;
				T result = caseSocialNetwork(socialNetwork);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Socialnetwork_one_onePackage.PERSON: {
				Person person = (Person)theEObject;
				T result = casePerson(person);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Socialnetwork_one_onePackage.CHILD: {
			...
			case Socialnetwork_one_onePackage.ADULT: {
